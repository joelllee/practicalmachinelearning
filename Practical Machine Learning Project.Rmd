...
As shown above, the accuracy for the Random Forest model is 99.7%. This shows that the Random Forest model is more accurate than the Linear Discriminant Analysis model. Hence, we choose to use the Random Forest model. 
